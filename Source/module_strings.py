...
#multiplayer game type names
  ...
  ("summoned_s12_zombies", "^In this scene of death and destruction, you are overcome by an urge to open the mysterious book in your inventory, and the strange symbols in it suddenly start to make sense.\
 Like in a dream, you begin chanting in a forgotten language and tracing glowing lines into the air. {reg12} of the slain rise again and are ready to do your bidding, while your companions stare at you in horror and bewilderment."),
