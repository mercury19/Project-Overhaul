 ...
 and that whatever course you take, great adventures will await you. Drawn by the stories you hear about Calradia and its kingdoms, you...",
    ...
    [
      ...
      ("town_2",[(eq, "$current_startup_quest_phase", 0),],"join a caravan to Reyvadin, in the Kingdom of the Vaegirs.",
       [ (assign, "$g_starting_town", "p_town_8"),
      ...
      ("town_3",[(eq, "$current_startup_quest_phase", 0),],"join a caravan to Tulga, in the Khergit Khanate.",
       [ (assign, "$g_starting_town", "p_town_10"),
      ...
      ("town_4",[(eq, "$current_startup_quest_phase", 0),],"take a ship to Sargoth, in the Kingdom of the Nords.",
       [ (assign, "$g_starting_town", "p_town_1"),
      ...
      ("town_5",[(eq, "$current_startup_quest_phase", 0),],"take a ship to Jelkala, in the Kingdom of the Rhodoks.",
       [ (assign, "$g_starting_town", "p_town_5"),
      ...
      ("town_6",[(eq, "$current_startup_quest_phase", 0),],"join a caravan to Shariz, in the Sarranid Sultanate.",
       [ (assign, "$g_starting_town", "p_town_19"),
         (assign, "$g_journey_string", "str_journey_to_shariz"),
		 (jump_to_menu, "mnu_start_phase_2_5"),
       ]),
	   
      ("tutorial_cheat",[(is_edit_mode_enabled)],"{!}CHEAT!",
       [
         ...
         (troop_raise_skill, "trp_player", skl.leadership, 7),
         (troop_raise_skill, "trp_player", skl.prisoner_management, 5),
         (troop_raise_skill, "trp_player", skl.inventory_management, 10),
         (party_add_members, "p_main_party", "trp_manhunter", 10),
         (troop_add_item, "trp_player","itm_khergit_guard_armor",0),
         (troop_add_item, "trp_player","itm_khergit_guard_helmet",0),
         (troop_add_item, "trp_player","itm_khergit_guard_boots",0),
         (troop_add_item, "trp_player","itm_heraldic_mail_with_surcoat",0),
         (troop_add_item, "trp_player","itm_mail_with_faction_surcoat",0),
         (troop_add_item, "trp_player","itm_shield_heater_faction",0),
         ...
         (troop_add_item, "trp_player","itm_military_cleaver_c",0),
		 
         (troop_add_item, "trp_player","itm_heavy_lance",0),
         (troop_add_item, "trp_player","itm_tab_shield_round_e",0),
         (troop_add_item, "trp_player","itm_war_darts",0),
  ...
  # This menu doesn't need to be here, specifically, but it's short and makes for a good placeholder
  ("auto_return",0,"{!}This menu automatically returns to caller.","none",[(change_screen_return, 0)],[]),
  
  # Must absolutely be in position #4 - Called when starting the tutorial
  ...
  # Must absolutely be in position #5 - Called when clicking the Reports button from the map
  ("reports",0,
  ...
  # Must absolutely be in position #7 - Called before returning to the main menu after a custom battle
...
Gradually, faith became such a part of your life that it was no different from the blood coursing through your veins."),
  ...
  (
    ...
    [],
    [
      ("page",[(eq,"$background_type",cb_noble)
 ...
 got the better deal."),
	(jump_to_menu,"mnu_start_character_3"),
      ...
      ("urchin",[(neq,"$background_type",cb_noble)
          ],"A street urchin.",[
 ...
 to watch your antics. Over time you became a performer well capable of attracting a crowd."),
	(jump_to_menu,"mnu_start_character_3"),
      ...
      ("courtier",[(eq,"$background_type",cb_noble)],"A courtier's child.",[
      (assign,"$background_answer_2",cb2_courtier),
      (assign, reg3, "$character_gender"),
      (str_store_string,s11,"@As a {reg3?girl:boy} growing out of childhood,\
 you spent much of your life at court, inserting yourself into the tightly-knit circles of nobility.\
 With the years you became more and more involved with the politics and intrigue demanded of a high-born {reg3?woman:man}.\
 You could not afford to remain a stranger to backstabbing and political violence, even if you wanted to."),
	(jump_to_menu,"mnu_start_character_3"),
   ]),
      ("noble",[(neq,"$background_type",cb_noble)],"A patrician's child.",[
      (assign,"$background_answer_2",cb2_noble),
      (assign, reg3, "$character_gender"),
      (try_begin),
      (eq,"$character_gender",tf_male),
      (str_store_string,s11,"@As a boy growing out of childhood,\
 you were trained and educated to perform the duties and wield the rights of a rich landowner.\
 The managing of taxes and rents were equally important in your education as diplomacy and even\
 personal defence. You learned everything you needed to administer the property of your parents."),
      (else_try),
      (str_store_string,s11,"@As a girl growing out of childhood,\
 you were trained and educated to the duties of a rich {s13}. You learned much about the household arts,\
 but even more about diplomacy and decorum, and all the things that a future husband might choose to speak of.\
 Truly, you became every inch as shrewd as any trader, though it would be rude to admit it aloud."),
      (try_end),
	  (jump_to_menu,"mnu_start_character_3"),
   ]),
      ("acolyte",[],"A cleric acolyte.",[
      (assign,"$background_answer_2",cb2_acolyte),
      (assign, reg3, "$character_gender"),
 ...
 After that you were no longer an acolyte {reg3?girl:boy}, but a {reg3?woman:man} waiting to take your vows into the service of your faith."),
	(jump_to_menu,"mnu_start_character_3"),
   ]),
      ("go_back",[],"Go back.",
     [(jump_to_menu,"mnu_start_character_1"),
  ...
  (
    ...
    [
      ...
      ("squire",[(eq,"$character_gender",tf_male),
				 (eq,"$background_type",cb_noble)],"A squire.",[
        (assign,"$background_answer_3",cb3_squire),
 ...
 of men who used guile as well as valor to achieve their aims."),
	(jump_to_menu,"mnu_start_character_4"),
      ...
      ("lady",[(eq,"$character_gender",tf_female),
			   (eq,"$background_type",cb_noble)],"A lady-in-waiting.",[
 ...
 with a little bit of subtlety."),
	(jump_to_menu,"mnu_start_character_4"),
     ...
     ("bravo",[],"A bounty hunter.",[
       (assign,"$background_answer_3",cb3_bravo),
     (str_store_string,s14,"@{reg3?daughter:man}"),
     (str_store_string,s13,"@{reg3?woman:man}"),
     (str_store_string,s12,"@Though the distinction felt sudden to you,\
 somewhere along the way you had become a {s13}, and the whole world seemed to change around you.\
 ...
 Going from fight to fight, you grew experienced at battle, and you learned what it was to kill."),
	(jump_to_menu,"mnu_start_character_4"),
     ...
     ("merc",[(neq,"$background_type",cb_noble)],"A sellsword.",[
       (assign,"$background_answer_3",cb3_merc),
     (str_store_string,s14,"@{reg3?daughter:man}"),
     (str_store_string,s13,"@{reg3?woman:man}"),
     (str_store_string,s12,"@Though the distinction felt sudden to you,\
 somewhere along the way you had become a {s13}, and the whole world seemed to change around you.\
 ...
 firewood that warmed many freezing homes during winter. All for a few silvers, of course."),
	(jump_to_menu,"mnu_start_character_4"),
     ...
     ("preacher",[],"A preacher.",[
       (assign,"$background_answer_3",cb3_preacher),
     (str_store_string,s14,"@{reg3?daughter:man}"),
     (str_store_string,s13,"@{reg3?woman:man}"),
     (str_store_string,s12,"@Though the distinction felt sudden to you,\
 somewhere along the way you had become a {s13}, and the whole world seemed to change around you.\
 You packed your few belongings and went out into the world to spread the holy words. You preached to\
 ...
 hospitality of the peasantry was always generous to a rising {s13} of the faith."),
	(jump_to_menu,"mnu_start_character_4"),
       ]),
      ("go_back",[],"Go back.",
       [(jump_to_menu,"mnu_start_character_2"),
 ...
 freedom to travel, you could no longer bear to stay in the same place. You simply went and never looked back..."),
     ...
     ("fervor",[],"Search for enlightenment.",[
       (assign,"$background_answer_4",cb4_fervor),
     (str_store_string,s13,"@Only you know exactly what caused you to give up your old life and become an adventurer.\
 Regardless, the restlessness in your soul would not let you find peace in any single place.\
 There were open questions in your mind, and their answers would not be found in books. While you preach wherever you go,\
 seeking to bring salvation and revelation to the masses, you can not find the same fervor as in the old days. A piece\
 is missing now, making you feel empty inside..."),
       (jump_to_menu,"mnu_choose_skill"),
       ]),
  ...
  (
    ...
    [
      ...
      (try_begin),
        ...
        (troop_add_item, "trp_player","itm_tab_shield_round_a",imod.battered),
      ...
      (else_try),
        ...
        (troop_add_item, "trp_player","itm_tab_shield_kite_b",imod.battered),
      ...
      (else_try),
        ...
        (troop_raise_proficiency, "trp_player",wpt_archery,30),
        (troop_raise_proficiency, "trp_player",wpt_throwing,10),
        (troop_add_item, "trp_player","itm_tab_shield_small_round_a",imod.battered),
    ...
    (else_try),
        ...
        (troop_raise_skill, "trp_player","skl_trade",1),
	(else_try),
        (eq,"$background_answer_2",cb2_mummer),
        (troop_raise_attribute, "trp_player",ca_agility,1),
        (troop_raise_attribute, "trp_player",ca_charisma,1),
        (troop_raise_skill, "trp_player","skl_athletics",1),
        (troop_raise_skill, "trp_player","skl_riding",1),
	...
	(else_try),
        (eq,"$background_answer_2",cb2_courtier),
        (troop_raise_attribute, "trp_player",ca_intelligence,1),
        (troop_raise_attribute, "trp_player",ca_strength,1),
        (troop_raise_skill, "trp_player","skl_persuasion",1),
        (troop_raise_skill, "trp_player","skl_weapon_master",1),
	...
	(else_try),
        ...
        (call_script,"script_change_troop_renown", "trp_player", 15),
	(else_try),
        (eq,"$background_answer_2",cb2_acolyte),
        (troop_raise_attribute, "trp_player",ca_intelligence,2),
        (troop_raise_skill, "trp_player",skl.leadership,1),
        (troop_raise_skill, "trp_player",skl.first_aid,1),
        (troop_raise_proficiency, "trp_player",wpt_polearm,10),
        (call_script,"script_change_troop_renown", "trp_player", 5),
	(try_end),

	(try_begin),
        (eq,"$background_answer_3",cb3_bravo),
        ...
        (troop_add_item, "trp_player","itm_sumpter_horse"),
        (troop_add_item, "trp_player","itm_sausages",0),
    (else_try),
        (eq,"$background_answer_3",cb3_merc),
        (troop_raise_attribute, "trp_player",ca_strength,1),
        (troop_raise_attribute, "trp_player",ca_agility,1),
        (troop_raise_skill, "trp_player","skl_ironflesh",1),
        (troop_raise_skill, "trp_player","skl_power_strike",1),
        ...
        (troop_add_item, "trp_player","itm_spiked_helmet",imod.crude),
        (troop_add_item, "trp_player","itm_tribal_warrior_outfit",imod.ragged),
    ...
    (else_try),
        ...
        (troop_add_item, "trp_player","itm_axe",imod.chipped),
        ...
        (troop_add_item, "trp_player","itm_sumpter_horse",imod.heavy),
        (troop_add_item, "trp_player","itm_dried_meat",0),
        (troop_add_item, "trp_player","itm_dried_meat",0),
    ...
    (else_try),
        ...
        (troop_add_item, "trp_player","itm_leather_boots",imod.ragged),
        (troop_add_item, "trp_player","itm_coarse_tunic",0),
        (troop_add_item, "trp_player","itm_sword_medieval_b", imod.balanced),
    ...
    (else_try),
        ...
        (troop_add_item, "trp_player","itm_leather_gloves",imod.plain),
        ...
        (troop_add_item, "trp_player","itm_smoked_fish",0),
    (else_try),
        (eq,"$background_answer_3",cb3_preacher),
        (troop_raise_attribute, "trp_player",ca_strength,1),
        (troop_raise_attribute, "trp_player",ca_charisma,1),
        (troop_raise_skill, "trp_player","skl_persuasion",1),
        (troop_raise_skill, "trp_player","skl_wound_treatment",1),
        ...
        (troop_add_item, "trp_player","itm_pilgrim_disguise",0),
        (troop_add_item, "trp_player","itm_pilgrim_hood",0),
        (troop_add_item, "trp_player","itm_wrapping_boots",0),
        (troop_add_item, "trp_player","itm_staff",imod.heavy),
        (troop_add_item, "trp_player","itm_smoked_fish",0),
        (troop_add_item, "trp_player","itm_sumpter_horse",0),
    (else_try),
        ...
        (troop_add_item, "trp_player","itm_tabard",imod.sturdy),
        (troop_add_item, "trp_player","itm_leather_boots",imod.ragged),
        (troop_add_item, "trp_player","itm_sword_medieval_a", imod.rusty),
        (troop_add_item, "trp_player","itm_hunting_crossbow", 0),
        (troop_add_item, "trp_player","itm_bolts", 0),
        (troop_add_item, "trp_player","itm_saddle_horse",imod.swaybacked),
        (troop_add_item, "trp_player","itm_smoked_fish",0),
    (else_try),
        ...
        (troop_add_item, "trp_player","itm_leather_jerkin",imod.ragged),
        (troop_add_item, "trp_player","itm_leather_boots",imod.tattered),
    ...
    (else_try),
        ...
        (troop_add_item, "trp_player","itm_hunting_crossbow",0),
        (troop_add_item, "trp_player","itm_bolts",0),
        (troop_add_item, "trp_player","itm_courser", imod.spirited),
        (troop_add_item, "trp_player","itm_woolen_hood",imod.sturdy),
        (troop_add_item, "trp_player","itm_woolen_dress",imod.sturdy),
        (troop_add_gold, "trp_player", 100),
        (troop_raise_proficiency, "trp_player",wpt_one_handed_weapon,10),
    ...
    (else_try),
        ...
        (troop_add_item, "trp_player","itm_linen_tunic",imod.sturdy),
    ...
    (try_end),
      ...
      (else_try),
        ...
        (troop_raise_skill, "trp_player","skl_pathfinding",1),
      (else_try),
        (eq,"$background_answer_4",cb4_fervor),
        (troop_raise_attribute, "trp_player",ca_intelligence,2),
        (troop_raise_skill, "trp_player","skl_wound_treatment",1),
      (else_try),
...
####################################################################################################################  
  ...
  ("camp_cheat",0,
   ...
   [(try_begin),
      ...
      (party_get_position, pos2, "p_temp_party_2"),
	  (store_distance_to_party_from_party, reg1, "p_main_party", "p_temp_party_2"),
	  (position_get_x, ":pos1_x", pos1), (position_get_y, ":pos1_y", pos1), (position_get_z, reg2, pos1),
	  (position_get_x, ":pos2_x", pos2), (position_get_y, ":pos2_y", pos2),
	  (call_script,"script_warp_fp_number",":pos1_x"),(str_store_string_reg,s1,s0),
	  (call_script,"script_warp_fp_number",":pos1_y"),(str_store_string_reg,s2,s0),
	  (call_script,"script_warp_fp_number",":pos2_x"),(str_store_string_reg,s4,s0),
	  (call_script,"script_warp_fp_number",":pos2_y"),(str_store_string_reg,s5,s0),
	  (str_store_string,s1,"@You are at {s1}, {s2} - {reg2} paces above sea level.^The reference point is at {s4}, {s5} - {reg1} miles from here.^^"),
	(else_try),
      (str_clear, s1),
	(try_end),  
     ],
  ...
  (
    ...
    [      
        ...
        (else_try),
		  ...
		  (try_begin),
			(eq, ":leader_troop_faction", fac.kingdom_1),
            (set_background_mesh, "mesh_pic_swad"),
		  (else_try),
			(eq, ":leader_troop_faction", fac.kingdom_2),
            (set_background_mesh, "mesh_pic_vaegir"),
		  (else_try),
			(eq, ":leader_troop_faction", fac.kingdom_3),
            (set_background_mesh, "mesh_pic_khergit"),
		  (else_try),
			(eq, ":leader_troop_faction", fac.kingdom_4),
            (set_background_mesh, "mesh_pic_nord"),
		  (else_try),
			(eq, ":leader_troop_faction", fac.kingdom_5),
            (set_background_mesh, "mesh_pic_rhodock"),
		  (else_try),
			(eq, ":leader_troop_faction", fac.kingdom_6),
  ...
  (
    ...
    [
        ...
        (else_try),
          ...
          (party_get_num_companion_stacks, ":num_stacks", "p_total_enemy_casualties"), #p.encountered changed to total_enemy_casualties			        
          (try_for_range, ":stack_no", "$last_defeated_hero", ":num_stacks"), #May 31 bug note -- this now returns some heroes in victorious party as well as in the other party
            ...
            (try_begin),
			  ...
			  (try_begin),
				(eq, "$cheat_mode", 1),
				(display_message, "@{!}{s4} skipped in p.total_enemy_casualties capture queue because is friendly"),
			  (try_end),			
			(else_try),
              (try_begin),
        ...
        (else_try),          
          ...
          (call_script, "script_party_calculate_loot", "p_total_enemy_casualties"), #p.encountered_party_backup changed to total_enemy_casualties
          (gt, reg0, 0),          
        ...
        (else_try),
          ...
          (try_begin),
            ...
            (end_current_battle),
          (try_end),
          (call_script, "script_party_give_xp_and_gold", "p_total_enemy_casualties"), #p.encountered_party_backup changed to total_enemy_casualties
          (try_begin),
            (eq, "$g_enemy_party", 0),
...
# Towns
  (
    "zendar",mnf_enable_hot_keys|mnf_scale_picture,
 ...
 but no banner is flown above the gates. Zendar is proud of keeping its neutrality and providing a safe haven to anyone in need of refuge.",
    ...
    [
      ("zendar_enter",[],"Take a walk around the streets.",[(assign, "$talk_context", 0),
															(set_jump_mission,"mt_town_default"),
															(jump_to_scene,"scn_zendar_center"),
															(change_screen_mission)],"Door to the town center."),
      ("zendar_tavern",[],"Visit the tavern.",[(call_script,"script_enter_tavern","p_zendar")],"Door to the tavern."),
      ("zendar_merchant",[],"Speak with the pawnbroker.",[(set_jump_mission,"mt_town_default"),
													(jump_to_scene,"scn_zendar_merchant"),
													(change_screen_mission)],"Door to the pawn shop."),
      ("zendar_arena",[(eq,1,0)],"Enter the arena.",[(set_jump_mission,"mt_town_default"),
                                                   (jump_to_scene,"scn_zendar_arena"),
                                                   (change_screen_mission)],"Door to the arena."),
      ("zendar_bodger",[(eq,1,0)],"Speak with the polearm merchant.",[(set_jump_mission,"mt_town_default"),
																	  (jump_to_scene,"scn_zendar_bodger"),
																	  (change_screen_mission)],"Door to the polearm shop."),
      ("zendar_fight_club",[(eq,1,0)],"Enter the fight cellar.",[(set_jump_mission,"mt_town_default"),
																(jump_to_scene,"scn_fight_cellar"),
																(change_screen_mission)],"Door to the cellar."),
  ...
  (
    "salt_mine",mnf_enable_hot_keys|mnf_scale_picture,
    "Spotting a path winding through the rocky part of the steppes, you decide to follow it, wondering what people\
 might be doing this far out in the barren wilderness. Coming closer, you notice a small group of houses, as well as\
 several mine shafts and huge piles of salt. There seem to be only two people outside; rather few for such a large enterprise.",
    "none",
    [(set_background_mesh, "mesh_pic_village_s")],
    [
      ("enter",[],"Approach.",[(assign, "$talk_context", 0),(set_jump_mission,"mt_town_default"),(jump_to_scene,"scn_salt_mine"),(change_screen_mission)]),
      ("leave",[],"Leave.",[(leave_encounter),(change_screen_return)]),
    ]
  ),
  (
    "four_ways_inn",mnf_enable_hot_keys|mnf_scale_picture,
    "The Four Ways Inn has, not entirely undeservedly, earned a reputation as a wretched hive of scum and villainy. The Thieves' Guild\
 is said to be involved in everything that happens here, but rarely takes direct action. This place is also rumored to be occasionally\
 visited by less honorable lords seeking to recruit spies or even assassins. You might be well advised to watch your back at all times.",
    "none",
    [(set_background_mesh, "mesh_pic_village_p")],
    [
      ("inn_enter",[],"Take a walk outside.",[(assign, "$talk_context", 0),(set_jump_mission,"mt_town_default"),(jump_to_scene,"scn_four_ways_inn"),(change_screen_mission)],"Door outside."),
      ("inn_tavern",[],"Visit the tavern.",[(call_script,"script_enter_tavern","p_four_ways_inn")],"Door to the tavern."),
	  ("inn_wait",
      [ (assign, ":can_rest", 1),
        (str_clear, s1),
        (try_begin),
      ...
      ("inn_leave",[],"Leave.",[(leave_encounter),(change_screen_return)]),
    ]
  ),
  (
    "dhorak_keep",mnf_enable_hot_keys|mnf_scale_picture,
    "The ruins of Dhorak Keep, once a mighty stronghold, stand overlooking this mountain pass. Built during the early days\
 of the Old Calradian Empire, it was eventually abandoned and fell into disrepair. Bandits and robber barons occupied it over the\
 centuries, until they were recently booted out by the Sword Sisters who are now starting to restore its former glory.",
    "none",
    [(set_background_mesh, "mesh_pic_castle1")],
    [
      ("keep_enter",[],"Take a walk around the courtyard.",[(assign, "$talk_context", 0),(set_jump_mission,"mt_town_default"),(jump_to_scene,"scn_dhorak_keep"),(change_screen_mission)]),
	  ("keep_wait",
      [ (assign, ":can_rest", 1),
        (str_clear, s1),
        (try_begin),
      ...
      ("keep_leave",[],"Leave.",[(leave_encounter),(change_screen_return)]),
    ]
  ),
   ...
   (
    ...
    [
        ...
        (else_try),
          (set_background_mesh, "mesh_pic_siege_sighted"),
        (try_end),
        (assign, ":result", "$g_battle_result"),#will be reset at script.encounter_calculate_fit
        (call_script, "script_encounter_calculate_fit"),
...
####################################################################################################################  
  ...
  (
    ...
    [
        ...
        (assign, "$g_battle_result", 0),
        (assign, "$qst.collect_taxes_currently_collecting", 0),
        (assign, "$qst.train_peasants_against_bandits_currently_training", 0),
        ...
        (try_begin),
          ...
          (store_add, "$qst.eliminate_bandits_infesting_village_num_bandits", ":player_level", 10),
          (val_mul, "$qst.eliminate_bandits_infesting_village_num_bandits", 12),
          (val_div, "$qst.eliminate_bandits_infesting_village_num_bandits", 10),
          (store_random_in_range, "$qst.eliminate_bandits_infesting_village_num_villagers", 25, 30),
          (assign, reg8, "$qst.eliminate_bandits_infesting_village_num_bandits"),
          (str_store_troop_name_by_count, s35, ":bandit_troop", "$qst.eliminate_bandits_infesting_village_num_bandits"),
    ...
    [
      ...
      ("village_attack_bandits",[(party_slot_ge, "$current_town", slot_village_infested_by_bandits, 1),],
       ...
       [(party_get_slot, ":bandit_troop", "$current_town", slot_village_infested_by_bandits),
        ...
        (reset_visitors),
        (set_visitors, 0, ":bandit_troop", "$qst.eliminate_bandits_infesting_village_num_bandits"),
        (set_visitors, 2, "trp_farmer", "$qst.eliminate_bandits_infesting_village_num_villagers"),
        (set_party_battle_mode),
...
#           (party_add_template, "$current_town", "pt_villagers_in_raid"),
 ...
 but they offer you all they can find.",
    ...
    [(party_get_slot, ":bandit_troop", "$g_encountered_party", slot_village_infested_by_bandits),
     (party_set_slot, "$g_encountered_party", slot_village_infested_by_bandits, 0),
     (party_clear, "p_temp_party"),
     (party_add_members, "p_temp_party", ":bandit_troop", "$qst.eliminate_bandits_infesting_village_num_bandits"),
    ...
    [
      ("continue",[],"Continue...",
       [(set_jump_mission,"mt_back_alley_kill_local_merchant"),
        (party_get_slot, ":town_alley", "$qst.kill_local_merchant_center", slot_town_alley),
...
####################################################################################################################  
 ...
 In addition to honour, fame and glory, you earn a prize of {reg9} denars. {s8}",
    ...
    [
	    ...
	    (remove_party, "$tournament_entry_point_party"), (assign, "$tournament_entry_point_party", 0),
        ],
    [
      ("continue", [], "Continue...",
       [(jump_to_menu, "mnu_town"),
  ...
  (
    ...
    "none",
    [
      (call_script, "script_warp_array_filter", "$tournament_participant_party", "script_cf_gt0"),
      (call_script, "script_warp_array_shuffle", "$tournament_participant_party"), # Will not be used any more
	  (assign, ":winner_troop", "trp_champion_fighter"),
      (try_begin),
        (call_script, "script_cf_warp_array_get", "$tournament_participant_party", 1),
  ...
  (
    ...
    "{s1}You are at tier {reg0} of the tournament, with {reg1} participants remaining. In the next round, there will be {reg2} teams with {reg4?{reg3} fighters:one fighter} each.",
    "none",
    [
        ...
        (else_try),
          (try_begin),
            ...
            (call_script, "script_assign_tournament_teams_for_next_round", ":town_max_teams", ":town_max_team_size"),
            (assign, "$g_tournament_next_num_teams", reg0),
            (assign, "$g_tournament_next_team_size", reg1),
			(store_mul, "$g_tournament_num_participants_for_fight", reg0, reg1),
          (try_end),
    ...
    [
      ...
      ("tournament_bet", [(gt, "$g_tournament_cur_tier", "$g_tournament_last_bet_tier")], "Place a bet on yourself.",
       [(jump_to_menu, "mnu_tournament_bet"),
        ]),
      ("tournament_select_equipment", [], "Choose your equipment.",
       [(jump_to_menu, "mnu_tournament_equipment"),
        ]),
      ("tournament_join_next_fight", [], "Fight in the next round.",
       [
           ...
           (party_get_slot, ":town_original_faction", "$current_town", slot_center_original_faction),
		   (assign, ":first_armor_item", "itm_arena_tunic_red"),
		   (assign, ":first_helmet_item", -1),
		   (assign, ":first_shield_item", "itm_arena_shield_red"),
           (try_begin),
             (eq, ":town_original_faction", "fac_kingdom_1"), # Swadia
		     (assign, ":first_armor_item", "itm_arena_armor_red"),
		     (assign, ":first_helmet_item", "itm_tourney_helm_red"),
           (else_try),
             (eq, ":town_original_faction", "fac_kingdom_2"), # Vaegir
		     (assign, ":first_armor_item", "itm_arena_armor_red"),
           ...
           (else_try),
		     ...
		     (assign, ":first_armor_item", "itm_arena_armor_red"),
           (else_try),
             (eq, ":town_original_faction", "fac_kingdom_5"), # Rhodok
		     (assign, ":first_helmet_item", "itm_arena_helmet_red"),
           (else_try),
             (eq, ":town_original_faction", "fac_kingdom_6"), # Sarranid
		     (assign, ":first_helmet_item", "itm_arena_turban_red"),
           (try_end),
	       ...
	       (try_for_range, ":id", 1, ":total_participants"),
		     ...
		     (assign, ":participant", reg0), (ge, ":participant", 0),
		     (call_script, "script_cf_warp_array_get", "$tournament_entry_point_party", ":id"),
		     (assign, ":entry", reg0), (ge, ":entry", 0),
			 (mission_tpl_entry_clear_override_items, "mt_arena_melee_fight", ":entry"),
			 (store_div, ":team_item_offset", ":entry", 8),
		     (call_script, "script_cf_warp_array_get", "$tournament_equipment_party", ":id"),
		     (assign, ":equipment_slot", reg0),
			 (try_begin), # Assign Horse
			   (ge, ":equipment_slot", slot_town_tournament_weapon_end),
			   (val_sub, ":equipment_slot", tournament_weapon_horse_offset),
			   (lt, ":equipment_slot", ":first_foot_slot"),
			   (mission_tpl_entry_add_override_item, "mt_arena_melee_fight", ":entry", "itm_practice_horse"),
			 (else_try),
			   (lt, ":equipment_slot", ":first_optional_slot"),
			   (mission_tpl_entry_add_override_item, "mt_arena_melee_fight", ":entry", "itm_practice_horse"),
			 (try_end),
			 (party_get_slot, ":primary_equipment", "$current_town", ":equipment_slot"),
			 (try_begin),
			   (try_begin), # Assign Armor
			     (gt, ":first_armor_item", 0),
			     (store_add, ":armor_item", ":first_armor_item", ":team_item_offset"),
			     (mission_tpl_entry_add_override_item, "mt_arena_melee_fight", ":entry", ":armor_item"),
			     (gt, ":first_helmet_item", 0),
			     (store_add, ":helmet_item", ":first_helmet_item", ":team_item_offset"),
			     (mission_tpl_entry_add_override_item, "mt_arena_melee_fight", ":entry", ":helmet_item"),
			   (try_end),
			   (gt, ":primary_equipment", 0), # Assign Primary Weapon
			   (mission_tpl_entry_add_override_item, "mt_arena_melee_fight", ":entry", ":primary_equipment"),
			   (try_begin),
			   ...
			   (try_end),
			   (try_begin), # Secondary Equipment
			     (eq, ":primary_equipment", "itm_practice_bow"),
			     (mission_tpl_entry_add_override_item, "mt_arena_melee_fight", ":entry", "itm_practice_arrows"),
			     (mission_tpl_entry_add_override_item, "mt_arena_melee_fight", ":entry", "itm_practice_dagger"),
			   (else_try),
			     (eq, ":primary_equipment", "itm_practice_crossbow"),
			     (mission_tpl_entry_add_override_item, "mt_arena_melee_fight", ":entry", "itm_practice_bolts"),
			     (mission_tpl_entry_add_override_item, "mt_arena_melee_fight", ":entry", "itm_practice_sword"),
			   (else_try),
			     (eq, ":primary_equipment", "itm_practice_javelin"), # Not in vanilla, but the AI loves to throw away the last one
			     (mission_tpl_entry_add_override_item, "mt_arena_melee_fight", ":entry", "itm_practice_dagger"),
			   (try_end),
			 (try_end),
			 # Finally, Place Troop
			 (try_begin),
			   (troop_is_hero, ":participant"),
			   (set_visitor, ":entry", ":participant"),
			 (else_try),
			   (call_script, "script_rand", 0, 1000000), # Troop DNA
  ...
  (
    ...
    [
      ...
      (store_add, reg3, "$g_tournament_bet_win_amount", "$g_tournament_bet_placed"),
  ...
  (
    ...
    [
      (call_script, "script_get_tournament_bets"),
      (store_add, ":player_bets", "$temp", reg0),
      (store_mul, ":win_amount", "$temp", reg1),
      (val_div, ":win_amount", ":player_bets"),
	  (val_add, ":win_amount", "$temp"),
      (assign, reg1, "$temp"),
  ...
  (
    ...
    "You ask one of the criers for the names of the other tournament participants. {s11}",
    "none",
    [
        (str_store_string, s11, "@They are:^"),
        #(call_script, "script_warp_array_copy", "$tournament_participant_party", "p_temp_party"), # unnecessary; we don't shuffle participants any more
	    #(call_script,"script_warp_array_sort", "p_temp_party", "script_cf_more_important_participant"),
	    (call_script,"script_warp_array_length", "$tournament_participant_party"),
        (assign, ":num_participants", reg0), (val_add, ":num_participants", 1), (assign, ":regulars", 0), (assign, ":heroes", 0),
        (try_for_range, ":id", 2, ":num_participants"), # Player is 1
	      (call_script, "script_cf_warp_array_get", "$tournament_participant_party", ":id"),
		  (gt,reg0,0), # Skip the disqualified
		  (try_begin),
		    (troop_is_hero, reg0),
            (str_store_troop_name, s12, reg0),
		...
		(try_begin),
		  (eq, ":heroes", 0),
		  (str_store_string, s11, "@You recognize none of them."),
		(else_try),
		  (eq, ":regulars", 1),
          (str_store_string, s11, "@{s11}^And one commoner who did not enter a name."),
		(else_try),
		  (gt, ":regulars", 1), (assign, reg1, ":regulars"),
          (str_store_string, s11, "@{s11}^And {reg1} commoners who did not enter names."),
        (try_end),
        ],
    [
      ("go_back_dot", [], "Go back.",
  ...
  (
    "tournament_equipment",0,
    "You are currently using {s1}. The following choices are available:",
    "none",
    [ (call_script, "script_cf_warp_array_get", "$tournament_equipment_party", 1),
	  (try_begin),
	    (call_script, "script_cf_write_tournament_weapon_to_s0", reg0),
	    (str_store_string_reg, s1, s0),
	  (else_try),
	    (str_store_string, s1, "@random equipment"),
	  (try_end),
      (assign, reg2, "$g_tournament_bet_placed"),
      (store_add, reg3, "$g_tournament_bet_win_amount", "$g_tournament_bet_placed"),
      (call_script, "script_get_tournament_bets"),
    ...
    [
      ("equip_match", [], "Whatever matches my current equipment best.",
       [ (call_script, "script_pick_matching_tournament_weapon_in_town", "trp_player", "$current_town"),
		 (try_begin),
		   (gt, reg1, 0),
		   (val_add, reg0, tournament_weapon_horse_offset),
		 (try_end),
         (call_script, "script_cf_warp_array_set", "$tournament_equipment_party", 1, reg0),
		 (jump_to_menu, "mnu_town_tournament"),
        ]),
		
      ("equip_random", [], "Random equipment.",
       [ (call_script, "script_pick_random_tournament_weapon_in_town", "trp_player", "$current_town"),
		 (try_begin),
		   (gt, reg1, 0),
		   (val_add, reg0, tournament_weapon_horse_offset),
		 (try_end),
      ...
      ("equip_1_horse", [(store_add, ":slot", slot_town_tournament_weapon_1, tournament_weapon_horse_offset),
                         (call_script, "script_cf_write_tournament_weapon_to_s0", ":slot")],
       "{s0}.",
       [ (store_add, ":slot", slot_town_tournament_weapon_1, tournament_weapon_horse_offset),
         (call_script, "script_cf_warp_array_set", "$tournament_equipment_party", 1, ":slot"),
         (jump_to_menu, "mnu_town_tournament"),
        ]),
      ("equip_1_foot", [(call_script, "script_cf_write_tournament_weapon_to_s0", slot_town_tournament_weapon_1)],
       "{s0}.",
       [ (call_script, "script_cf_warp_array_set", "$tournament_equipment_party", 1, slot_town_tournament_weapon_1),
         (jump_to_menu, "mnu_town_tournament"),
        ]),
		
      ("equip_2_horse", [(store_add, ":slot", slot_town_tournament_weapon_2, tournament_weapon_horse_offset),
                         (call_script, "script_cf_write_tournament_weapon_to_s0", ":slot")],
       "{s0}.",
       [ (store_add, ":slot", slot_town_tournament_weapon_2, tournament_weapon_horse_offset),
         (call_script, "script_cf_warp_array_set", "$tournament_equipment_party", 1, ":slot"),
         (jump_to_menu, "mnu_town_tournament"),
        ]),
      ("equip_2_foot", [(call_script, "script_cf_write_tournament_weapon_to_s0", slot_town_tournament_weapon_2)],
       "{s0}.",
       [ (call_script, "script_cf_warp_array_set", "$tournament_equipment_party", 1, slot_town_tournament_weapon_2),
         (jump_to_menu, "mnu_town_tournament"),
        ]),
		
      ("equip_3_horse", [(store_add, ":slot", slot_town_tournament_weapon_3, tournament_weapon_horse_offset),
                         (call_script, "script_cf_write_tournament_weapon_to_s0", ":slot")],
       "{s0}.",
       [ (store_add, ":slot", slot_town_tournament_weapon_3, tournament_weapon_horse_offset),
         (call_script, "script_cf_warp_array_set", "$tournament_equipment_party", 1, ":slot"),
         (jump_to_menu, "mnu_town_tournament"),
        ]),
      ("equip_3_foot", [(call_script, "script_cf_write_tournament_weapon_to_s0", slot_town_tournament_weapon_3)],
       "{s0}.",
       [ (call_script, "script_cf_warp_array_set", "$tournament_equipment_party", 1, slot_town_tournament_weapon_3),
         (jump_to_menu, "mnu_town_tournament"),
        ]),
		
      ("equip_4_horse", [(store_add, ":slot", slot_town_tournament_weapon_4, tournament_weapon_horse_offset),
                         (call_script, "script_cf_write_tournament_weapon_to_s0", ":slot")],
       "{s0}.",
       [ (store_add, ":slot", slot_town_tournament_weapon_4, tournament_weapon_horse_offset),
         (call_script, "script_cf_warp_array_set", "$tournament_equipment_party", 1, ":slot"),
         (jump_to_menu, "mnu_town_tournament"),
        ]),
      ("equip_4_foot", [(call_script, "script_cf_write_tournament_weapon_to_s0", slot_town_tournament_weapon_4)],
       "{s0}.",
       [ (call_script, "script_cf_warp_array_set", "$tournament_equipment_party", 1, slot_town_tournament_weapon_4),
         (jump_to_menu, "mnu_town_tournament"),
        ]),
		
      ("equip_5_horse", [(store_add, ":slot", slot_town_tournament_weapon_5, tournament_weapon_horse_offset),
                         (call_script, "script_cf_write_tournament_weapon_to_s0", ":slot")],
       "{s0}.",
       [ (store_add, ":slot", slot_town_tournament_weapon_5, tournament_weapon_horse_offset),
         (call_script, "script_cf_warp_array_set", "$tournament_equipment_party", 1, ":slot"),
         (jump_to_menu, "mnu_town_tournament"),
        ]),
      ("equip_5_foot", [(call_script, "script_cf_write_tournament_weapon_to_s0", slot_town_tournament_weapon_5)],
       "{s0}.",
       [ (call_script, "script_cf_warp_array_set", "$tournament_equipment_party", 1, slot_town_tournament_weapon_5),
         (jump_to_menu, "mnu_town_tournament"),
        ]),
		
      ("equip_6_horse", [(store_add, ":slot", slot_town_tournament_weapon_6, tournament_weapon_horse_offset),
                         (call_script, "script_cf_write_tournament_weapon_to_s0", ":slot")],
       "{s0}.",
       [ (store_add, ":slot", slot_town_tournament_weapon_6, tournament_weapon_horse_offset),
         (call_script, "script_cf_warp_array_set", "$tournament_equipment_party", 1, ":slot"),
         (jump_to_menu, "mnu_town_tournament"),
        ]),
      ("equip_6_foot", [(call_script, "script_cf_write_tournament_weapon_to_s0", slot_town_tournament_weapon_6)],
       "{s0}.",
       [ (call_script, "script_cf_warp_array_set", "$tournament_equipment_party", 1, slot_town_tournament_weapon_6),
         (jump_to_menu, "mnu_town_tournament"),
        ]),
		
      ("equip_7_horse", [(store_add, ":slot", slot_town_tournament_weapon_7, tournament_weapon_horse_offset),
                         (call_script, "script_cf_write_tournament_weapon_to_s0", ":slot")],
       "{s0}.",
       [ (store_add, ":slot", slot_town_tournament_weapon_7, tournament_weapon_horse_offset),
         (call_script, "script_cf_warp_array_set", "$tournament_equipment_party", 1, ":slot"),
         (jump_to_menu, "mnu_town_tournament"),
        ]),
      ("equip_7_foot", [(call_script, "script_cf_write_tournament_weapon_to_s0", slot_town_tournament_weapon_7)],
       "{s0}.",
       [ (call_script, "script_cf_warp_array_set", "$tournament_equipment_party", 1, slot_town_tournament_weapon_7),
         (jump_to_menu, "mnu_town_tournament"),
        ]),
  ...
  (
    ...
    [(call_script, "script_get_max_skill_of_player_party", "skl_trade"),
     ...
     (try_begin),
       ...
       (try_begin),
         (party_slot_eq, "$current_town", slot_party_type, spt_town),
         (store_div, "$qst.collect_taxes_total_hours", 24* 7 * 30, ":max_skill_plus_thirty"),
       (else_try),
         #Village
         (store_div, "$qst.collect_taxes_total_hours", 24 * 3 * 30, ":max_skill_plus_thirty"),
       (try_end),

       (call_script, "script_party_count_fit_for_battle", "p_main_party"),
       (val_add, reg0, 20),
       (val_mul, "$qst.collect_taxes_total_hours", 20),
       (val_div, "$qst.collect_taxes_total_hours", reg0),

     
       (quest_set_slot, "qst_collect_taxes", slot_quest_target_amount, "$qst.collect_taxes_total_hours"),
       (store_div, ":menu_begin_time", "$qst.collect_taxes_total_hours", 20),#between %5-%25
       (store_div, ":menu_end_time", "$qst.collect_taxes_total_hours", 4),
       (assign, ":unrest_begin_time", ":menu_end_time"),#between %25-%75
       (store_mul, ":unrest_end_time", "$qst.collect_taxes_total_hours", 3),
       (val_div, ":unrest_end_time", 4),

       (val_mul, ":tax_quest_expected_revenue", 2),
       (store_div, "$qst.collect_taxes_hourly_income", ":tax_quest_expected_revenue", "$qst.collect_taxes_total_hours"),
     
       (store_random_in_range, "$qst.collect_taxes_menu_counter", ":menu_begin_time", ":menu_end_time"),
       (store_random_in_range, "$qst.collect_taxes_unrest_counter", ":unrest_begin_time", ":unrest_end_time"),
       (assign, "$qst.collect_taxes_halve_taxes", 0),
     (try_end),
    ...
    [
      ("start_collecting", [], "Start collecting.",
       [(assign, "$qst.collect_taxes_currently_collecting", 1),
        (try_begin),
          (quest_slot_eq, "qst_collect_taxes", slot_quest_current_state, 0),
 ...
 They're getting very restless, and they may react badly if you keep pressing them.",
    ...
    [
      ...
      ("halve_taxes", [(quest_get_slot, ":quest_giver_troop", "qst_collect_taxes", slot_quest_giver_troop),
       ...
       [(assign, "$qst.collect_taxes_halve_taxes", 1),
        (change_screen_return),
        ]),
    ]
  ),
...
# They must learn field discipline and the steadiness to follow orders in combat before they can be thought to use arms.",
  (
    ...
    [(call_script, "script_get_max_skill_of_player_party", "skl_trainer"),
     ...
     (store_sub, reg4, ":needed_hours", "$qst.train_peasants_against_bandits_num_hours_trained"),
     ],
    [
      ("make_preparation", [], "Train them.",
       [
         (assign, "$qst.train_peasants_against_bandits_currently_training", 1),
         (rest_for_hours_interactive, 1000, 5, 0), #rest while not attackable
         (assign, "$auto_enter_town", "$current_town"),
         (assign, "$g_town_visit_after_rest", 1),
         (change_screen_return),
    ...
    [
	  ...
	  [
	    ...
	    (else_try),
	      ...
	      (party_get_slot, ":starting_town_culture", "$g_starting_town", slot_center_culture),
           
	      (try_begin),
	        (eq, ":starting_town_culture", "fac_culture_1"), #player selected swadian city as starting town.
	        (assign, ":scene_to_use", "scn_lair_forest_bandits"),	    
	      (else_try),
	        (eq, ":starting_town_culture", "fac_culture_2"), #player selected Vaegir city as starting town.
	        (assign, ":scene_to_use", "scn_lair_taiga_bandits"),	    
	      (else_try),
	        (eq, ":starting_town_culture", "fac_culture_3"), #player selected Khergit city as starting town.
	        (assign, ":scene_to_use", "scn_lair_steppe_bandits"),	    
	      (else_try),
	        (eq, ":starting_town_culture", "fac_culture_4"), #player selected Nord city as starting town.
	        (assign, ":scene_to_use", "scn_lair_sea_raiders"),
	      (else_try),
	        (eq, ":starting_town_culture", "fac_culture_5"), #player selected Rhodok city as starting town.
	        (assign, ":scene_to_use", "scn_lair_mountain_bandits"),
	      (else_try),
	        (eq, ":starting_town_culture", "fac_culture_6"), #player selected Sarranid city as starting town.
	        (assign, ":scene_to_use", "scn_lair_desert_bandits"),	    
	      (try_end),  
	    (else_try),
...
####################################################################################################################
  ...
  ("start_phase_3",mnf_disable_all_keys,
    ...
    [
      ("continue",[], "Continue...",
       [         
         (party_get_slot, ":town_culture", "$g_starting_town", slot_center_culture),
         (call_script, "script_set_player_culture", ":town_culture"),
  ...
  ("start_phase_4",mnf_disable_all_keys,
    ...
    [
      ...
      [         
        ...
        (party_get_slot, ":culture", "$g_starting_town", slot_center_culture),
        (try_begin),
