 ...
 You want everything, and you won't let anyone stop you from having it..."),
  ...
  (
    ...
    (else_try),
        ...
        (troop_add_item, "trp_player","itm_spiked_helmet",imod_crude),
        (troop_add_item, "trp_player","itm_tribal_warrior_outfit",imod_ragged),
    ...
    (else_try),
        ...
        (troop_add_item, "trp_player","itm_staff",imod_heavy),
        (troop_add_item, "trp_player","itm_smoked_fish",0),
        (troop_add_item, "trp_player","itm_sumpter_horse",0),
    (else_try),
 ...
 and then put the buildings to the torch. From the coins and valuables that are found, you get your share of {reg1} denars.{s12}",
    ...
    [
        ...
        (try_begin),
		  ...
		  (assign, reg12, reg0),
		  (str_store_string, s12, s.summoned_s12_zombies),
        (try_end),
